...
# 修改主机名字，把Project修改你喜欢的就行（不能使用中文）
sed -i '/uci commit system/i\uci set system.@system[0].hostname='Project'' package/lean/default-settings/files/zzz-default-settings
